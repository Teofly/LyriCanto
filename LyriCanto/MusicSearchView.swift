        ...
        VStack(spacing: 16) {
            ...
            HStack {
                TextField("Es: Artist - Song Title", text: $searchQuery)
                    .textFieldStyle(ThemedTextFieldStyle(colorScheme: colorScheme))
                    .onSubmit {
                        performSearch()
                    }
                ...
                .buttonStyle(ThemedProminentButtonStyle(colorScheme: colorScheme))
    ...
    private func resultCard(_ result: MusicSearchResult) -> some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 8)
                .fill(colorScheme.currentScheme.background.color)
        )
    }
